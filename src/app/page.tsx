...
export default function Home() {
  ...
  const handleShare = async () => {
    try {
      const prizeText = prizeWon === 0 ? '精準體育單' : `${prizeWon}獎金`;
          ...
          <div className="flex justify-center mb-4">
            {logoLoaded ? (
              ...
              <>
                ...
                />
                {/* Placeholder logo - shown when real logo is not uploaded */}
                <img
                  src="https://i.ibb.co/DDqcs0H4/drw.png"
                    ...
                    return (
                      <div key={record.id} className="flex justify-between items-center py-2 border-b border-yellow-500/20 last:border-0">
                        ...
                        <span className="font-bold gold-gradient">
                          {record.prize === 0 ? '精準體育單' : `${record.prize} 獎金`}
                        </span>
